...
void HAL_XSPI_MspInit(XSPI_HandleTypeDef* hxspi)
{
  ...
  */
    ...
    PN4     ------> XSPIM_P2_IO2
    */
    GPIO_InitStruct.Pin = GPIO_PIN_1|GPIO_PIN_11|GPIO_PIN_3|GPIO_PIN_10
                          |GPIO_PIN_0|GPIO_PIN_9|GPIO_PIN_2|GPIO_PIN_5
                          |GPIO_PIN_6|GPIO_PIN_8|GPIO_PIN_4;
...
void HAL_XSPI_MspDeInit(XSPI_HandleTypeDef* hxspi)
{
  if(hxspi->Instance==XSPI2)
  {
    ...
    PN4     ------> XSPIM_P2_IO2
    */
    HAL_GPIO_DeInit(GPION, GPIO_PIN_1|GPIO_PIN_11|GPIO_PIN_3|GPIO_PIN_10
                          |GPIO_PIN_0|GPIO_PIN_9|GPIO_PIN_2|GPIO_PIN_5
                          |GPIO_PIN_6|GPIO_PIN_8|GPIO_PIN_4);
